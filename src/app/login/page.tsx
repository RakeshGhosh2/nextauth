        ...
        <div className="min-h-screen bg-black text-white flex items-center justify-center">
            <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
                ...
                <form className="my-8" onSubmit={onLogin}>
                    ...
                    >
                        {loading ? "Processing..." : (buttonDisabled ? "Fill all fields" : "Login")} &rarr;
                        <BottomGradient />
                    </button>

                    <div className="text-center mt-4">
                        <Link href="/signup" className="text-sm text-neutral-600 hover:text-neutral-400 dark:text-neutral-400 dark:hover:text-neutral-200">
